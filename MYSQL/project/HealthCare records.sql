...
(1, 'WBC Count Normal', 7.5, 'x10^9/L', '4.0-11.0 x10^9/L', 'Normal', '2025-01-11 09:00:00'),
(2, 'Fracture Observed', NULL, NULL, 'N/A', 'Abnormal', '2025-01-16 10:00:00'),
(3, 'ECG Normal', NULL, NULL, '60-100 bpm', 'Normal', '2025-01-23 11:00:00'),
(4, 'Gallstones detected', NULL, NULL, 'N/A', 'Abnormal', '2025-02-03 14:00:00'),
(5, 'MRI Normal', NULL, NULL, 'N/A', 'Normal', '2025-02-10 12:00:00'),
(6, 'CT Scan Normal', NULL, NULL, 'N/A', 'Normal', '2025-02-15 13:30:00'),
(7, 'Mild Allergies', NULL, NULL, 'Negative', 'Mild', '2025-02-20 09:30:00'),
(8, 'Myopia detected', NULL, NULL, '20/20', 'Abnormal', '2025-02-25 10:15:00'),
(9, 'Hearing Normal', NULL, NULL, '0-20 dB', 'Normal', '2025-03-01 11:45:00'),
(10, 'High blood sugar', 150, 'mg/dL', '70-110 mg/dL', 'Abnormal', '2025-03-05 08:30:00'),
(11, 'Borderline Cholesterol', 210, 'mg/dL', '125-200 mg/dL', 'Borderline', '2025-03-08 09:00:00'),
(12, 'Kidney Function Normal', 1.1, 'mg/dL', '0.6-1.3 mg/dL', 'Normal', '2025-03-10 10:30:00'),
(13, 'Liver Function Normal', 40, 'U/L', '7-56 U/L', 'Normal', '2025-03-12 11:00:00'),
(14, 'Stress Test Normal', NULL, NULL, 'N/A', 'Normal', '2025-03-14 14:00:00'),
(15, 'Vaccination Completed', NULL, NULL, 'N/A', 'Normal', '2025-03-16 08:45:00'),
(16, 'Bone Density Low', -2.0, 'T-score', '-1 to -2.5', 'Abnormal', '2025-03-18 09:15:00'),
(17, 'Urine Normal', NULL, NULL, '1.005-1.030', 'Normal', '2025-03-20 10:00:00'),
(18, 'Pulmonary Normal', 95, '%', '80-120%', 'Normal', '2025-03-22 11:30:00'),
(19, 'Endoscopy Normal', NULL, NULL, 'N/A', 'Normal', '2025-03-24 12:00:00'),
(20, 'Polyp Found', NULL, NULL, 'N/A', 'Abnormal', '2025-03-26 13:00:00'),
(21, 'Cavity Observed', NULL, NULL, 'N/A', 'Abnormal', '2025-03-28 09:45:00'),
(22, 'Skin Biopsy Benign', NULL, NULL, 'N/A', 'Normal', '2025-03-30 10:15:00'),
(23, 'CT Angiography Normal', NULL, NULL, 'N/A', 'Normal', '2025-04-01 11:00:00'),
(24, 'MRI Brain Normal', NULL, NULL, 'N/A', 'Normal', '2025-04-03 08:30:00'),
(25, 'Thyroid Test Normal', 2.5, 'mIU/L', '0.4-4.0', 'Normal', '2025-04-05 09:00:00');
...
use healthcarerecord;
-- Retrieve all patients along with the doctors they have appointments with.
SELECT p.patient_name, d.doctor_name, a.appointment_date
FROM Appointments a
JOIN Patient p ON a.patient_id = p.patient_id
JOIN Doctor d ON a.doctor_id = d.doctor_id;

-- Find the total number of appointments each doctor has.
SELECT count(a.appointment_date),d.doctor_id
FROM Appointments a
-- JOIN Patient p ON a.patient_id = p.patient_id
JOIN Doctor d ON a.doctor_id = d.doctor_id group by d.doctor_id;

-- Display the list of patients who have both a vaccination and an allergy record.
SELECT DISTINCT p.patient_id, p.patient_name
FROM Patient p
JOIN Vaccination v ON p.patient_id = v.patient_id
JOIN Allergies a ON p.patient_id = a.patient_id;

-- Show the total billing amount per patient.
select b.total_amount,p.patient_name from billing b inner join patient p on p.patient_id=b.patient_id;

-- Retrieve all doctor schedules that overlap (i.e., where one doctor has overlapping times).
SELECT 
    ds1.doctor_id,
    d.doctor_name,
    ds1.day_of_week,
    ds1.schedule_id AS schedule_1,
    ds1.start_time AS start_time_1,
    ds1.end_time AS end_time_1,
    ds2.schedule_id AS schedule_2,
    ds2.start_time AS start_time_2,
    ds2.end_time AS end_time_2
FROM DoctorSchedules ds1
JOIN DoctorSchedules ds2 
    ON ds1.doctor_id = ds2.doctor_id
  --  AND ds1.day_of_week = ds2.day_of_week
   -- AND ds1.schedule_id < ds2.schedule_id   -- avoid comparing same or duplicate pairs
   -- AND ds1.start_time < ds2.end_time       -- overlap condition (part 1)
   -- AND ds1.end_time > ds2.start_time       -- overlap condition (part 2)
JOIN Doctor d ON ds1.doctor_id = d.doctor_id;

-- List patients who were hospitalized but don’t have any surgeries recorded.
Select p.patient_name,h.hospitalization_id from hospitalization h inner join patient p on p.patient_id=h.hospitalization_id
join  surgeries s on s.surgery_id != p.patient_id;

-- Display medications prescribed by a particular doctor (using joins with Prescription and Medication).
SELECT 
    d.doctor_name,
    p.patient_id,
    m.medication_name,
...
WHERE d.doctor_name = 'Dr. Rohan Sharma'; 
...
JOIN Prescriptions pr 
    ON pr.doctor_id = e.doctor_id 
   AND pr.patient_id = e.patient_id     -- ensure same doctor-patient pair
JOIN Prescription_Item pi ON pr.prescription_id = pi.prescription_id
JOIN Medication m ON pi.medication_id = m.medication_id
WHERE d.doctor_name = 'Dr. Raj Mehta';   -- 🔹 Change doctor name as needed
  -- 🔹 Change doctor name as needed
